...
* An active API key if you plan to use external third-party models.

## 🛠️ Application Features

The desktop client organizes complex AI workflows into a clean user interface.

* Native Runtime: The software connects directly to the grok build system. It processes data locally to ensure your tasks run efficiently.
* Parallel Sessions: You can open multiple work windows at the same time. This allows you